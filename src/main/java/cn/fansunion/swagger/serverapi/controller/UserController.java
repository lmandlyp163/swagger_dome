...
public class UserController {
	...
	@ApiOperation(value = "获得用户列表by_vo", notes = "列表信息by_vo", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "list_vo", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value = "list_string_json", method = RequestMethod.POST)
	...
	@ResponseBody
	@ApiOperation(value = "根据用户名获取list_string_variable", httpMethod = "GET", produces = MediaType.APPLICATION_JSON_VALUE, notes = "根据用户名获取用户对象")
	...
	@ApiOperation(value = "添加用户_return_string", notes = "获取商品信息(测试返回的string)", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "add_return_string", method = RequestMethod.POST)
	// @RequestBody只能有1个
	...
	@ApiOperation(value = "添加用户_return_vo", notes = "获取商品信息(测试返回的vo)", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "add_return_vo", method = RequestMethod.POST)
	...
	@ApiOperation(value = "添加用户_return_list_object", notes = "获取商品信息(测试返回的list_object)", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "add_return_list_object", method = RequestMethod.POST)
